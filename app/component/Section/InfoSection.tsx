...
function InfoSection() {
  return (
    <div
      className='w-full h-150 scroll-mt-15 flex flex-col items-center justify-center text-2xl font-bold bg-cover bg-center'
      style={{ backgroundImage: "url('/backIMG.avif')" }}
    >
        ...
        <div className='w-full h-70 flex items-center justify-center text-lg font-bold p-4'>            
            <Image src="/me.jpg" alt="Profile Image" width={150} height={150} className='rounded-full mb-4' />
